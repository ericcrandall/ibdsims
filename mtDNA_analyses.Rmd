...
for(m in list.files(path="./stepstone_mtdnas_g10k_Nl6_m.0001",pattern="AllIndividuals_rep[1-9].nex"))
  {
  
  #read in data and convert to gtypes
  nexus <- ape::read.nexus.data(paste("./stepstone_mtdnas_g10k_Nl6_m.0001/",m,sep=""))
  dna <- as.DNAbin(nexus)
...
ggsave("stepstone_mtdnas_g10k_Nl6_m.0001.pdf",argg)
