...
```{r ibdloop3-Theta}
outputs<-data.frame(model=character(),statistic=character(),Proportion_Sgnificant=numeric(),Rgreaterthan0=numeric(),Slopegreaterthan0=numeric())
...
ggsave("mantelhist_stepstoneFST_g10k_Nl4_m0.1.pdf",mantelhist)
...
ggsave("slopehist_stepstoneFST_g10k_Nl4_m0.1.pdf",slopehist)


outputs<-rbind(outputs,c(paste("Ne=",10^logne,"; m=",mig,sep=""),"Theta",sigp,Rgreaterthan0,slopegreaterthan0,mean(sigmas,na.rm=T)))
