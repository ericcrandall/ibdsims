...
for(m in list.files(path="./stepstone_mtdnas_Nl3_m.1",pattern="AllIndividuals_rep[1-9].nex"))
  {
  
  #read in data and convert to gtypes
  nexus <- ape::read.nexus.data(paste("./stepstone_mtdnas_Nl3_m.1/",m,sep=""))
  dna <- as.DNAbin(nexus)
...
ggsave("stepstone_mtdnas_Nl3_m.1.pdf",argg)
