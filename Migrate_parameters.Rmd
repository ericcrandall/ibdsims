...
```{r allviolinplots, echo=F}
 a<-data.frame(Ne=all_ne_ml4_m0.01,model="Ne = 10,000; m=0.01")
 b<-data.frame(Ne=all_ne_ml5_m0.001,model="Ne = 100,000; m=0.001")
 c<-data.frame(Ne=all_ne_ml6_m0.0001,model="Ne = 1,000,000; m=0.0001")
 allne<-rbind(a,b,c)
 trueNe<-data.frame(trueNe=c(10000,100000,1000000),model=levels(allne$model))

a<-data.frame(Nm=all_nm_ml4_m0.01,model="Ne = 10,000; m=0.01")
b<-data.frame(Nm=all_nm_ml5_m0.001,model="Ne = 100,000; m=0.001")
c<-data.frame(Nm=all_nm_ml6_m0.0001,model="Ne = 1,000,000; m=0.0001")
 allnm<-rbind(a,b,c)
 trueNm<-data.frame(trueNe=c(100,100,100),model=levels(allne$model))
 
 violin_ne<-ggplot(allne, (aes(x=model, y=Ne))) + geom_violin()  + 
    scale_y_log10(breaks=c(0.00001,0.0001,0.001,0.01,0.1,1,10,100,1000,10000,100000,1000000),limits=c(1000,1000000), labels=c("0.00001","0.0001","0.001","0.01","0.1","1","10","100","1,000","10,000","100,000","1,000,000")) +
    labs(title=element_blank(), x="Model", y="Effective Population Size") + 
   theme(axis.title.x=element_blank(), axis.text.y=element_text(size=18), axis.title.y=element_text(size=14),axis.text.x=element_text(size=16)) + geom_point(data=trueNe,mapping=aes(x=model,y=trueNe),color="red",size=4)
 
 
 violin_nm<-ggplot(allnm, (aes(x=model, y=Nm))) + geom_violin()  + 
    scale_y_log10(breaks=c(0.00001,0.0001,0.001,0.01,0.1,1,10,100,1000,10000,100000,1000000),limits=c(1,1000), labels=c("0.00001","0.0001","0.001","0.01","0.1","1","10","100","1,000","10,000","100,000","1,000,000")) +
    labs(title=element_blank(), x="Model", y="Effective Population Size") + 
   theme(axis.title.x=element_blank(), axis.text.y=element_text(size=18), axis.title.y=element_text(size=14),axis.text.x=element_text(size=16)) + geom_point(data=trueNm,mapping=aes(x=model,y=trueNe),color="red",size=4)
